  ...
  <div class="logistics">
    ...
    <van-row type="flex" align="center" justify="center" class="m-t-10">
      ...
      <van-col :span="20">
        ...
        <div class="single-number">物流订单：213315462132</div>
      </van-col>
    </van-row>
    <!-- 用户信息 -->
    <van-row type="flex" align="center" justify="center" class="m-t-10">
    ...
    <van-steps direction="vertical" active-color="red" :active="0">
      ...
      <van-step>
        <h4>正在派送途中，请您准备签收(派件人：刘军，电话：1346464546)</h4>
        <p>2020-08-02 13:15</p>
      </van-step>
      <van-step>
        <h4>快件到达【广州市海珠区北山村营业部】</h4>
        <p>2020-08-01 22:45</p>
      </van-step>
      <van-step>
        <h4>快件在【广州新塘集散中心】已装车，准备发往【广州市海珠区北山村营业部】</h4>
        <p>2020-08-01 12:21</p>
      </van-step>
      <van-step>
        <h4>顺丰速运 已经取快件</h4>
        <p>2020-08-01 9:40</p>
