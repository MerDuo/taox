<template>
  <div class="panel-card">
    ...
    <div class="container">
      ...
      <!-- 收藏,转发,采购 -->
      <van-row class="favorite-share" type="flex" justify="space-between" align="center">
        <van-col>
          <van-icon size=".5rem" name="star-o" />
          <span>收藏</span>
        </van-col>
        <van-col>
          <van-icon size=".5rem" name="share" />
          <span @click="showShare = true">转发</span>
