        ...
        <van-cell-group>
          <van-cell title="微信支付" clickable @click="radio = '1'">
            ...
            <div slot="icon" class="m-r-5">
              <van-icon name="wechat" size="1.56rem" color="rgb(54, 203, 89)" />
            </div>
            <van-radio slot="right-icon" checked-color="#FF5000" name="1" />
          </van-cell>
          <van-cell title="支付宝支付" clickable @click="radio = '2'">
            <!-- 支付宝支付 -->
            <div slot="icon" class="m-r-5">
              <van-icon name="alipay" size="1.56rem" color="rgb(1, 170, 239)" />
            </div>
            <van-radio slot="right-icon" checked-color="#FF5000" name="2" />
          </van-cell>
          <van-cell title="余额支付" clickable @click="radio = '3'">
            <!-- 余额支付 -->
            <div slot="icon" class="m-r-5">
              <van-icon name="gold-coin" size="1.56rem" color="rgb(254, 142, 46)" />
            </div>
            <van-radio slot="right-icon" checked-color="#FF5000" name="3" />
          </van-cell>
        </van-cell-group>
      </van-radio-group>
      <!-- 确认支付按钮 -->
